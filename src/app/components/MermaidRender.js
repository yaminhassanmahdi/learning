...
export default function RichMermaidMarkdown({ mark }) {
    // Define Mermaid chart content as a string (without triple backticks)
    const mermaidChart = `
flowchart TD
...
`;
    ...
    // Combine it into proper Markdown using triple backticks at render time
    const markdownContent = mark || `\`\`\`mermaid\n${mermaidChart}\n\`\`\``;
    ...
    return (
        <ReactMarkdown
            ...
            components={{
                ...
                strong: ({ node, ...props }) => <strong className="font- text-green-400 dark:text-green-300/90" {...props} />,
